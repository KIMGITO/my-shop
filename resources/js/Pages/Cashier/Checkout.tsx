    ...
    export default function CashierCheckout() {
        ...
        const handleCompleteSale = async (paymentData: any) => {
            ...
            const transactionData = {
                ...
                total,
                payment_details: {
                    cash_received: paymentData.cash,
                    mpesa_received: paymentData.mpesa,
                    credit_amount: paymentData.credit,
                    change_given: paymentData.change,
                },
                customer_id: selectedId,
                customer_name: customer?.label || "Walk-in Customer",
                    ...
                    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        >
                            ...
                            <PaymentTerminal
                                ...
                                onCustomerChange={(id) => setSelectedId(id)}
                                allowCredit={true}
